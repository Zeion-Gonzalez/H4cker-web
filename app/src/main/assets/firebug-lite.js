 ...
 */
var FBL={};
(function(){var productionDir="nope";
...
this.shutdown()
},testMenu:function(){var firebugMenu=new Menu({id:"fbFirebugMenu",items:[{label:"Open Firebug",type:"shortcut",key:isFirefox?"Shift+F12":"F12",checked:true,command:"toggleChrome"},{label:"Inspect Element",type:"shortcut",key:"Ctrl+Shift+C",command:"toggleInspect"},{label:"Command Line",type:"shortcut",key:"Ctrl+Shift+L",command:"focusCommandLine"},"-",{label:"Options",type:"group",child:"fbFirebugOptionsMenu"}],onHide:function(){iconButton.restore()
...
function touchHandler(event) {
  ...
  if(touch.target == "div.cssRule") {
  event.preventDefault();
  }
}

function init() {
  document.getElementById('FirebugUI').contentWindow.document.addEventListener("touchstart", touchHandler, true);
  document.getElementById('FirebugUI').contentWindow.document.addEventListener("touchmove", touchHandler, true);
  document.getElementById('FirebugUI').contentWindow.document.addEventListener("touchend", touchHandler, true);
  document.getElementById('FirebugUI').contentWindow.document.addEventListener("touchcancel", touchHandler, true);

  var head = document.getElementById('FirebugUI').contentWindow.document.getElementsByTagName("head")[0];
  var style = document.createElement('style');
  style.textContent ='#fbWindow_btDetach{display:none;} #fbWindow_btDeactivate{display:none;}';
