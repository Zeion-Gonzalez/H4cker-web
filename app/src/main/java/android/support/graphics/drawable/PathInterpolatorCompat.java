...
public class PathInterpolatorCompat implements Interpolator {
    ...
    private void initPath(Path path) {
        ...
        if (Math.abs(this.f15mX[0]) > 1.0E-5d || Math.abs(this.f16mY[0]) > 1.0E-5d || Math.abs(this.f15mX[numPoints - 1] - 1.0f) > 1.0E-5d || Math.abs(this.f16mY[numPoints - 1] - 1.0f) > 1.0E-5d) {
