...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    /* loaded from: classes.dex */
    class C03121 implements ThreadUtil.MainThreadCallback<T> {
        ...
        private Runnable mMainThreadRunnable = new Runnable() { // from class: android.support.v7.util.MessageThreadUtil.1.1
            ...
            public void run() {
                SyncQueueItem msg = C03121.this.mQueue.next();
                while (msg != null) {
                    switch (msg.what) {
                        case 1:
                            C03121.this.val$callback.updateItemCount(msg.arg1, msg.arg2);
                            break;
                        case 2:
                            C03121.this.val$callback.addTile(msg.arg1, (TileList.Tile) msg.data);
                            break;
                        case 3:
                            C03121.this.val$callback.removeTile(msg.arg1, msg.arg2);
                            break;
                        default:
                            Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                            break;
                    }
                    msg = C03121.this.mQueue.next();
                }
            }
        };

        C03121(ThreadUtil.MainThreadCallback mainThreadCallback) {
    ...
    public ThreadUtil.MainThreadCallback<T> getMainThreadProxy(ThreadUtil.MainThreadCallback<T> callback) {
        return new C03121(callback);
    }

    /* renamed from: android.support.v7.util.MessageThreadUtil$2 */
    /* loaded from: classes.dex */
    class C03132 implements ThreadUtil.BackgroundCallback<T> {
                    ...
                    if (msg != null) {
                        switch (msg.what) {
                            case 1:
                                ...
                                C03132.this.val$callback.refresh(msg.arg1);
                                break;
                            case 2:
                                C03132.this.mQueue.removeMessages(2);
                                C03132.this.mQueue.removeMessages(3);
                                C03132.this.val$callback.updateRange(msg.arg1, msg.arg2, msg.arg3, msg.arg4, msg.arg5);
                                break;
                            case 3:
                                C03132.this.val$callback.loadTile(msg.arg1, msg.arg2);
                                break;
                            case 4:
                                C03132.this.val$callback.recycleTile((TileList.Tile) msg.data);
                                break;
                            default:
                                Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                                break;
        ...
        C03132(ThreadUtil.BackgroundCallback backgroundCallback) {
