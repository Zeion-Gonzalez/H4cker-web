...
class TwilightCalculator {
    ...
    public void calculateTwilight(long time, double latitude, double longitude) {
        ...
        float n = (float) Math.round((daysSince2000 - f34J0) - arcLongitude);
        double solarTransitJ2000 = f34J0 + n + arcLongitude + (0.0053d * Math.sin(meanAnomaly)) + ((-0.0069d) * Math.sin(2.0d * solarLng));
