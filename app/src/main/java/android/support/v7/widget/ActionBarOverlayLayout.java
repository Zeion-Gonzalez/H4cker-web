...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = {C0306R.attr.actionBarSize, 16842841};
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0306R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0306R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0306R.id.action_bar));
        }
    }
