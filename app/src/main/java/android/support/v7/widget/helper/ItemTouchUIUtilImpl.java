    ...
    static class Api21Impl extends BaseImpl {
        ...
        public void onDraw(Canvas c, RecyclerView recyclerView, View view, float dX, float dY, int actionState, boolean isCurrentlyActive) {
            if (isCurrentlyActive) {
                Object originalElevation = view.getTag(C0307R.id.item_touch_helper_previous_elevation);
                if (originalElevation == null) {
                    ...
                    view.setTag(C0307R.id.item_touch_helper_previous_elevation, originalElevation2);
                }
            }
        ...
        public void clearView(View view) {
            Object tag = view.getTag(C0307R.id.item_touch_helper_previous_elevation);
            if (tag != null && (tag instanceof Float)) {
                ViewCompat.setElevation(view, ((Float) tag).floatValue());
            }
            view.setTag(C0307R.id.item_touch_helper_previous_elevation, null);
