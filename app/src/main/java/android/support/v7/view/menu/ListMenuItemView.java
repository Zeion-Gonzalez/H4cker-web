...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView {
    ...
    public ListMenuItemView(Context context, AttributeSet attrs) {
        this(context, attrs, C0306R.attr.listMenuViewStyle);
    }

    public ListMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(getContext(), attrs, C0306R.styleable.MenuView, defStyleAttr, 0);
        this.mBackground = a.getDrawable(C0306R.styleable.MenuView_android_itemBackground);
        this.mTextAppearance = a.getResourceId(C0306R.styleable.MenuView_android_itemTextAppearance, -1);
        this.mPreserveIconSpacing = a.getBoolean(C0306R.styleable.MenuView_preserveIconSpacing, false);
        this.mTextAppearanceContext = context;
        this.mSubMenuArrow = a.getDrawable(C0306R.styleable.MenuView_subMenuArrow);
        a.recycle();
    }
    ...
    protected void onFinishInflate() {
        ...
        this.mTitleView = (TextView) findViewById(C0306R.id.title);
        if (this.mTextAppearance != -1) {
            this.mTitleView.setTextAppearance(this.mTextAppearanceContext, this.mTextAppearance);
        }
        this.mShortcutView = (TextView) findViewById(C0306R.id.shortcut);
        this.mSubMenuArrowView = (ImageView) findViewById(C0306R.id.submenuarrow);
    ...
    private void insertIconView() {
        ...
        this.mIconView = (ImageView) inflater.inflate(C0306R.layout.abc_list_menu_item_icon, (ViewGroup) this, false);
        addView(this.mIconView, 0);
    }

    private void insertRadioButton() {
        LayoutInflater inflater = getInflater();
        this.mRadioButton = (RadioButton) inflater.inflate(C0306R.layout.abc_list_menu_item_radio, (ViewGroup) this, false);
        addView(this.mRadioButton);
    }

    private void insertCheckBox() {
        LayoutInflater inflater = getInflater();
        this.mCheckBox = (CheckBox) inflater.inflate(C0306R.layout.abc_list_menu_item_checkbox, (ViewGroup) this, false);
