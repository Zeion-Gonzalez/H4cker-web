...
public class AppBarLayout extends LinearLayout {
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            ViewUtilsLollipop.setStateListAnimatorFromAttrs(this, attrs, 0, C0018R.style.Widget_Design_AppBarLayout);
        }
        TypedArray a = context.obtainStyledAttributes(attrs, C0018R.styleable.AppBarLayout, 0, C0018R.style.Widget_Design_AppBarLayout);
        ViewCompat.setBackground(this, a.getDrawable(C0018R.styleable.AppBarLayout_android_background));
        if (a.hasValue(C0018R.styleable.AppBarLayout_expanded)) {
            setExpanded(a.getBoolean(C0018R.styleable.AppBarLayout_expanded, false), false, false);
        }
        if (Build.VERSION.SDK_INT >= 21 && a.hasValue(C0018R.styleable.AppBarLayout_elevation)) {
            ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(this, a.getDimensionPixelSize(C0018R.styleable.AppBarLayout_elevation, 0));
        }
        if (Build.VERSION.SDK_INT >= 26) {
            if (a.hasValue(C0018R.styleable.AppBarLayout_android_keyboardNavigationCluster)) {
                setKeyboardNavigationCluster(a.getBoolean(C0018R.styleable.AppBarLayout_android_keyboardNavigationCluster, false));
            }
            if (a.hasValue(C0018R.styleable.AppBarLayout_android_touchscreenBlocksFocus)) {
                setTouchscreenBlocksFocus(a.getBoolean(C0018R.styleable.AppBarLayout_android_touchscreenBlocksFocus, false));
            }
        }
        a.recycle();
    ...
    private void setExpanded(boolean expanded, boolean animate, boolean force) {
        this.mPendingAction = (force ? 8 : 0) | (animate ? 4 : 0) | (expanded ? 1 : 2);
        requestLayout();
    }
    ...
    protected int[] onCreateDrawableState(int extraSpace) {
        ...
        extraStates[0] = this.mCollapsible ? C0018R.attr.state_collapsible : -C0018R.attr.state_collapsible;
        extraStates[1] = (this.mCollapsible && this.mCollapsed) ? C0018R.attr.state_collapsed : -C0018R.attr.state_collapsed;
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            this.mScrollFlags = 1;
            TypedArray a = c.obtainStyledAttributes(attrs, C0018R.styleable.AppBarLayout_Layout);
            this.mScrollFlags = a.getInt(C0018R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            if (a.hasValue(C0018R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                int resId = a.getResourceId(C0018R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0);
    ...
    public static class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        private void animateOffsetWithDuration(final CoordinatorLayout coordinatorLayout, final AppBarLayout child, int offset, int duration) {
            ...
            this.mOffsetAnimator.setDuration(Math.min(duration, (int) MAX_OFFSET_ANIMATION_DURATION));
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0018R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(a.getDimensionPixelSize(C0018R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            a.recycle();
        }
