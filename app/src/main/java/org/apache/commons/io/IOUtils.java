...
public class IOUtils {
    ...
    */
    public static boolean contentEqualsIgnoreEOL(java.io.Reader r5, java.io.Reader r6) throws java.io.IOException {
        /*
            java.io.BufferedReader r0 = toBufferedReader(r5)
    ...
    public static long skip(Reader input, long toSkip) throws IOException {
        ...
        long remain = toSkip;
        while (remain > 0) {
            long n = input.read(SKIP_CHAR_BUFFER, 0, (int) Math.min(remain, (long) PlaybackStateCompat.ACTION_PLAY_FROM_SEARCH));
            if (n < 0) {
                break;
            }
            remain -= n;
