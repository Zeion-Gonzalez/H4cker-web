...
public abstract class DirectoryWalker<T> {
    ...
    protected DirectoryWalker(IOFileFilter directoryFilter, IOFileFilter fileFilter, int depthLimit) {
        if (directoryFilter == null && fileFilter == null) {
            ...
            this.filter = FileFilterUtils.m2125or(FileFilterUtils.makeDirectoryOnly(directoryFilter == null ? TrueFileFilter.TRUE : directoryFilter), FileFilterUtils.makeFileOnly(fileFilter == null ? TrueFileFilter.TRUE : fileFilter));
        }
        this.depthLimit = depthLimit;
    }
