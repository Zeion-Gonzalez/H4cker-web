...
public class WavSplit {
    public static void main(String[] args) throws Exception {
        ...
        if (cmd.argsLength() < 1) {
            MainUtils.printHelp(new HashMap<String, String>() { // from class: org.jcodec.common.tools.WavSplit.1
                {
        ...
        for (int i = 0; i < channels; i++) {
            out[i] = NIOUtils.writableFileChannel(new File(s.getParentFile(), String.format(pattern, Integer.valueOf(i))));
