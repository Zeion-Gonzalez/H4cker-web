...
public class JpegConst {
    ...
    static {
        ...
        bldr3.set(MPEGConst.USER_DATA_START_CODE, "1111111111010000");
        bldr3.set(MPEGConst.SEQUENCE_HEADER_CODE, "1111111111010001");
        bldr3.set(MPEGConst.SEQUENCE_ERROR_CODE, "1111111111010010");
        bldr3.set(MPEGConst.EXTENSION_START_CODE, "1111111111010011");
        bldr3.set(182, "1111111111010100");
        bldr3.set(MPEGConst.SEQUENCE_END_CODE, "1111111111010101");
        bldr3.set(MPEGConst.GROUP_START_CODE, "1111111111010110");
        bldr3.set(185, "1111111111010111");
        bldr3.set(186, "1111111111011000");
        bldr3.set(SOF1, "1111111010");
        bldr3.set(SOF2, "1111111111011001");
        bldr3.set(SOF3, "1111111111011010");
        bldr3.set(DHT, "1111111111011011");
        bldr3.set(197, "1111111111011100");
        bldr3.set(198, "1111111111011101");
        bldr3.set(199, "1111111111011110");
        bldr3.set(ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, "1111111111011111");
        bldr3.set(201, "1111111111100000");
        bldr3.set(202, "1111111111100001");
        bldr3.set(RST1, "11111111000");
        bldr3.set(RST2, "1111111111100010");
        bldr3.set(RST3, "1111111111100011");
        bldr3.set(RST4, "1111111111100100");
        bldr3.set(RST5, "1111111111100101");
        bldr3.set(RST6, "1111111111100110");
        bldr3.set(RST7, "1111111111100111");
        bldr3.set(SOI, "1111111111101000");
        bldr3.set(EOI, "1111111111101001");
        bldr3.set(SOS, "1111111111101010");
        bldr3.set(APP1, "1111111111101011");
        bldr3.set(APP2, "1111111111101100");
        bldr3.set(APP3, "1111111111101101");
        bldr3.set(APP4, "1111111111101110");
        bldr3.set(APP5, "1111111111101111");
        bldr3.set(APP6, "1111111111110000");
        bldr3.set(APP7, "1111111111110001");
        bldr3.set(APP8, "1111111111110010");
        bldr3.set(APP9, "1111111111110011");
        bldr3.set(APPA, "1111111111110100");
        ...
        bldr3.set(ItemTouchHelper.Callback.DEFAULT_SWIPE_ANIMATION_DURATION, "1111111111111110");
        ...
        bldr4.set(MPEGConst.USER_DATA_START_CODE, "1111111111010010");
        bldr4.set(MPEGConst.SEQUENCE_HEADER_CODE, "1111111111010011");
        bldr4.set(MPEGConst.SEQUENCE_ERROR_CODE, "1111111111010100");
        bldr4.set(MPEGConst.EXTENSION_START_CODE, "1111111111010101");
        bldr4.set(182, "1111111111010110");
        bldr4.set(MPEGConst.SEQUENCE_END_CODE, "1111111111010111");
        bldr4.set(MPEGConst.GROUP_START_CODE, "1111111111011000");
        bldr4.set(185, "1111111111011001");
        bldr4.set(186, "1111111111011010");
        bldr4.set(SOF1, "111111010");
        bldr4.set(SOF2, "1111111111011011");
        bldr4.set(SOF3, "1111111111011100");
        bldr4.set(DHT, "1111111111011101");
        bldr4.set(197, "1111111111011110");
        bldr4.set(198, "1111111111011111");
        bldr4.set(199, "1111111111100000");
        bldr4.set(ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, "1111111111100001");
        bldr4.set(201, "1111111111100010");
        bldr4.set(202, "1111111111100011");
        bldr4.set(RST1, "11111111001");
        bldr4.set(RST2, "1111111111100100");
        bldr4.set(RST3, "1111111111100101");
        bldr4.set(RST4, "1111111111100110");
        bldr4.set(RST5, "1111111111100111");
        bldr4.set(RST6, "1111111111101000");
        bldr4.set(RST7, "1111111111101001");
        bldr4.set(SOI, "1111111111101010");
        bldr4.set(EOI, "1111111111101011");
        bldr4.set(SOS, "1111111111101100");
        bldr4.set(APP1, "11111111100000");
        bldr4.set(APP2, "1111111111101101");
        bldr4.set(APP3, "1111111111101110");
        bldr4.set(APP4, "1111111111101111");
        bldr4.set(APP5, "1111111111110000");
        bldr4.set(APP6, "1111111111110001");
        bldr4.set(APP7, "1111111111110010");
        bldr4.set(APP8, "1111111111110011");
        bldr4.set(APP9, "1111111111110100");
        bldr4.set(APPA, "1111111111110101");
        ...
        bldr4.set(ItemTouchHelper.Callback.DEFAULT_SWIPE_ANIMATION_DURATION, "1111111111111110");
